 ...
 * `terminarz`. „Tabele grup" (MVP-e) analogicznie → STAŁY URL `/tabele-grup/`.
 * „Reprezentacje" i grupa „Twoje" pozostają placeholderami (Faza MVP-g /
 * hajlajty-user). Strona główna kieruje do home_url. Markup/klasy 1:1 z monolitem.
 *
...
// URL „Tabele grup" (MVP-e) — STAŁY (slug `tabele-grup`), spójnie z terminarzem.
...
// URL „Faza pucharowa" (drabinka) — STAŁY (slug `faza-pucharowa`), spójnie z powyższymi.
// Stan aktywny po szablonie (działa niezależnie od slug-a).
$hajlajty_bracket_url    = home_url( '/faza-pucharowa/' );
$hajlajty_bracket_active = is_page_template( 'template-faza-pucharowa.php' ) ? ' is-active' : '';
...
<aside class="sidebar" id="sidebar" aria-label="Menu główne">
	...
	<nav class="sidebar__group">
		...
		<a class="nav-link<?php echo esc_attr( $hajlajty_bracket_active ); ?>" href="<?php echo esc_url( $hajlajty_bracket_url ); ?>"><svg viewBox="0 0 24 24"><path d="M4 5h6v6M4 13h6v6M14 8h6M14 16h6M10 8v8"/></svg> Faza pucharowa</a>
